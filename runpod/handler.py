...
def extract_frames_at_fps(video_path: str, target_fps: float = 3.0) -> List[Tuple[float, Image.Image]]:
...
def analyze_video_with_blip2(video_path: str, target_fps: float = 3.0) -> Dict[str, Any]:
    ...
    for i, (timestamp, image) in enumerate(frames_with_timestamps):
        try:
            ...
            feature_prompt = "Question: What notable features or amenities are visible? Answer:"
...
def process_video(video_url: str, job_id: str, target_fps: float = 3.0) -> Dict[str, Any]:
    ...
    try:
        ...
        summary = {
            "total_frames_analyzed": analysis_result["analysis_metadata"]["total_frames"],
            "fps_analyzed": target_fps,
            "rooms_detected": analysis_result["analysis_metadata"]["room_types_detected"],
            "sample_descriptions": [
                {
        ...
        return {
            ...
            "summary": summary,
            "frame_descriptions": analysis_result["frame_descriptions"],  # Include all descriptions
