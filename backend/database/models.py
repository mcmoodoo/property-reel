...
class ProcessingJob(Base):
    ...
    # Processing results
    result_s3_urls = Column(JSON, nullable=True, default=dict)  # Dict of result types -> URLs
    ...
    def update_runpod_info(self, runpod_job_id: str, runpod_status: Optional[str] = None):
